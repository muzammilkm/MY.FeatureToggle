...
{
    public abstract class BaseFeatureToggleProvider : IFeatureToggleProvider
    {
        private readonly ILdClient _ldClient;

        protected BaseFeatureToggleProvider(ILdClient ldClient)
        {
            _ldClient = ldClient;
        }
        ...
        {
            var user = GetUser(userAttributes);
            var feature = featureFlag.GetFlag();

            return _ldClient.BoolVariation(feature.Key, user, (bool)feature.DefaultValue);
        }
        ...
        public T Get<T>(Enum featureFlag, IDictionary<string, object> userAttributes = null)
        {
            ...
            switch (feature.Type)
            {
                case VariationType.Boolean:
                    ...
                    value = (T)Convert.ChangeType(_ldClient.BoolVariation(feature.Key, user, (bool)feature.DefaultValue), typeof(T));
                    break;
                case VariationType.String:
                    ...
                    value = (T)Convert.ChangeType(_ldClient.StringVariation(feature.Key, user, (string)feature.DefaultValue), typeof(T));
                    break;
                case VariationType.Number:
                    ...
                    value = (T)Convert.ChangeType(_ldClient.IntVariation(feature.Key, user, (int)feature.DefaultValue), typeof(T));
                    break;
                case VariationType.Float:
                    ...
                    value = (T)Convert.ChangeType(_ldClient.FloatVariation(feature.Key, user, (float)feature.DefaultValue), typeof(T));
                    break;
                case VariationType.ArrayOfString:
                    ...
                    var commaSeperateStr = _ldClient.StringVariation(feature.Key, user, (string)feature.DefaultValue);
                ...
                case VariationType.Json:
                    ...
                    value = (T)Convert.ChangeType(_ldClient.JsonVariation(feature.Key, user, (JToken)feature.DefaultValue), typeof(T));
                    break;
            }
